...
description: >-
  ...
  /knowledge /documents, or "登录公司系统/保存 odoo 账号". Treat bare work-context
  mentions of 待办/任务/项目/工时/客户/商机/会议/日程/提醒/知识库/文档 as this skill.
...
> **API/字段细节** → [todo](references/odoo-todo-api.md) · [project](references/odoo-project-api.md) · [timesheet](references/odoo-timesheet-api.md) · [crm](references/odoo-crm-api.md) · [activity+calendar](references/odoo-activity-calendar-api.md) · [calendar-advanced](references/odoo-calendar-advanced-api.md) · [knowledge+documents](references/odoo-knowledge-documents-api.md)
