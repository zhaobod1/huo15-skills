...
displayName: 火一五文档技能
description: 【青岛火一五信息科技有限公司】企业级 Word & PDF 文档生成 v7.4。**32 类规范**覆盖企业全场景：HR（个人简历/任命书/在职证明）、Sales（合同/报价单/招投标书）、PR（新闻稿/演讲稿/邀请函）、PM（项目立项书/项目计划书/复盘报告/项目结项报告/会议纪要）、Ops（应急预案/故障报告/操作SOP/部署文档/风险评估报告）、Tech（技术方案/需求文档/测试报告/API文档/用户手册/培训手册）、Finance/Legal（公司制度/备忘录/信函）、Reporting（公文/工作报告/商业计划书/研究报告/验收单）。三条路径：Word 直出、原生 PDF 直出、Word→PDF。v7.4 新增 15 类预设并配齐范本（templates/ 下 15 份可直接拷贝改写的 markdown 样例）。v7.3 重做"文档壳"：每种规范按真实场景决定是否带【内部】banner / 元数据表 / 版本史 / 审批 / TOC，CLI 可覆盖。触发词：写word、写文档、写PDF、生成word、生成PDF、写合同、写协议、写方案、写报告、写会议纪要、写需求文档、写商业计划书、写BP、写用户手册、写培训手册、写招标书、写投标书、写演讲稿、写研究报告、写白皮书、写验收单、写交付确认、写立项书、写可行性报告、写SOP、写作业指导书、写公司制度、写管理办法、写公函、写商务函件、写求职信、写简历、写CV、写报价单、写新闻稿、写复盘、写测试报告、写故障报告、写postmortem、写任命书、写聘任书、写应急预案、写在职证明、写风险评估、写项目计划书、写项目结项报告、写API文档、写接口文档、写部署文档、写runbook、写备忘录、写MOU、Word转PDF。
version: 7.4.0
aliases:
  - 火一五文档技能
  - 文档生成
...
## 一、v7.4 关键变化（再扩 15 类规范 + 配套 markdown 范本）
